...
public class CapersRepository {
    ...
    static final File CAPERS_FOLDER = new File(join(CWD, ".capers").toString());

    static final File STORY = new File(join(CAPERS_FOLDER, "story.txt").toString());
    ...
    public static void writeStory(String text) throws IOException {
        FileWriter fr = new FileWriter(STORY, true);
        fr.write(text + "\n");
        fr.close();
    ...
    public static void celebrateBirthday(String name) {
        ...
        dog.haveBirthday();
        File file = new File(join(DOG_FOLDER, name + ".txt").toString());
